"use strict";
(self["webpackChunktest_ng7"] = self["webpackChunktest_ng7"] || []).push([["src_app_layout_hourly-billing_hourly-billing_module_ts"],{

/***/ 99963:
/*!***************************************************************************************************************!*\
  !*** ./src/app/layout/hourly-billing/components/add-edit-hourly-billing/add-edit-hourly-billing.component.ts ***!
  \***************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AddEditHourlyBillingComponent": () => (/* binding */ AddEditHourlyBillingComponent)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _add_edit_hourly_billing_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-edit-hourly-billing.component.html?ngResource */ 43524);
/* harmony import */ var _add_edit_hourly_billing_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-edit-hourly-billing.component.scss?ngResource */ 48939);
...
/* harmony import */ var _service_hourly_billing_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../service/hourly-billing.service */ 95418);
...
let AddEditHourlyBillingComponent = class AddEditHourlyBillingComponent {
    //   public options: Object = {
    //     plugins: [ HtmlEmbed],
    //     toolbar: [ 'htmlEmbed'],
    // };
    constructor(router, fb, route, hourlyBillingService) {
        this.router = router;
        this.fb = fb;
        this.route = route;
...
AddEditHourlyBillingComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__.Router },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormBuilder },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__.ActivatedRoute },
    { type: _service_hourly_billing_service__WEBPACK_IMPORTED_MODULE_3__.HourlyBillingService }
];
AddEditHourlyBillingComponent.propDecorators = {
    newItemEvent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__.Output }]
};
AddEditHourlyBillingComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        selector: 'app-add-edit-hourly-billing',
        template: _add_edit_hourly_billing_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        animations: [(0,_app_router_animations__WEBPACK_IMPORTED_MODULE_2__.routerTransition)()],
        styles: [_add_edit_hourly_billing_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/***/ 62381:
/*!*********************************************************************************************!*\
  !*** ./src/app/layout/hourly-billing/components/hourly-billing/hourly-billing.component.ts ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "HourlyBillingComponent": () => (/* binding */ HourlyBillingComponent)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _hourly_billing_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hourly-billing.component.html?ngResource */ 16973);
/* harmony import */ var _hourly_billing_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hourly-billing.component.scss?ngResource */ 5850);
...
/* harmony import */ var _service_hourly_billing_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../service/hourly-billing.service */ 95418);
...
let HourlyBillingComponent = class HourlyBillingComponent {
    constructor(router, hourlyBillingService, cdr, jwtService, confirmationDialogService) {
        this.router = router;
        this.hourlyBillingService = hourlyBillingService;
        this.cdr = cdr;
...
HourlyBillingComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_10__.Router },
    { type: _service_hourly_billing_service__WEBPACK_IMPORTED_MODULE_5__.HourlyBillingService },
...
HourlyBillingComponent.propDecorators = {
...
HourlyBillingComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
        selector: 'app-hourly-billing',
        template: _hourly_billing_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        animations: [(0,_app_router_animations__WEBPACK_IMPORTED_MODULE_3__.routerTransition)()],
        styles: [_hourly_billing_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/***/ 27425:
/*!************************************************************************!*\
  !*** ./src/app/layout/hourly-billing/hourly-billing-routing.module.ts ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "HourlyBillingRoutingModule": () => (/* binding */ HourlyBillingRoutingModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 22560);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ 60124);
/* harmony import */ var _components_add_edit_hourly_billing_add_edit_hourly_billing_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/add-edit-hourly-billing/add-edit-hourly-billing.component */ 99963);
/* harmony import */ var _components_hourly_billing_hourly_billing_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/hourly-billing/hourly-billing.component */ 62381);
...
const routes = [
    {
        path: '',
        component: _components_hourly_billing_hourly_billing_component__WEBPACK_IMPORTED_MODULE_1__.HourlyBillingComponent
    },
    {
        path: 'add-hourly-billing',
        component: _components_add_edit_hourly_billing_add_edit_hourly_billing_component__WEBPACK_IMPORTED_MODULE_0__.AddEditHourlyBillingComponent
    },
    {
...
let HourlyBillingRoutingModule = class HourlyBillingRoutingModule {
};
HourlyBillingRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/***/ 15027:
/*!****************************************************************!*\
  !*** ./src/app/layout/hourly-billing/hourly-billing.module.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "HourlyBillingModule": () => (/* binding */ HourlyBillingModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/core */ 22560);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/common */ 94666);
/* harmony import */ var _hourly_billing_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hourly-billing-routing.module */ 27425);
/* harmony import */ var _components_hourly_billing_hourly_billing_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/hourly-billing/hourly-billing.component */ 62381);
/* harmony import */ var _components_add_edit_hourly_billing_add_edit_hourly_billing_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/add-edit-hourly-billing/add-edit-hourly-billing.component */ 99963);
...
/* harmony import */ var _service_hourly_billing_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./service/hourly-billing.service */ 95418);
...
let HourlyBillingModule = class HourlyBillingModule {
};
HourlyBillingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.NgModule)({
        declarations: [
            _components_hourly_billing_hourly_billing_component__WEBPACK_IMPORTED_MODULE_1__.HourlyBillingComponent,
            _components_add_edit_hourly_billing_add_edit_hourly_billing_component__WEBPACK_IMPORTED_MODULE_2__.AddEditHourlyBillingComponent
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_8__.CommonModule,
            _hourly_billing_routing_module__WEBPACK_IMPORTED_MODULE_0__.HourlyBillingRoutingModule,
        ...
        providers: [_shared_directives__WEBPACK_IMPORTED_MODULE_5__.NgbdSortableHeader, _service_hourly_billing_service__WEBPACK_IMPORTED_MODULE_4__.HourlyBillingService]
    })
], HourlyBillingModule);
...
/***/ 48939:
/*!****************************************************************************************************************************!*\
  !*** ./src/app/layout/hourly-billing/components/add-edit-hourly-billing/add-edit-hourly-billing.component.scss?ngResource ***!
  \****************************************************************************************************************************/
/***/ ((module) => {

module.exports = ".ck.ck-content {\n  border: 2px solid #707070 !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 5850:
/*!**********************************************************************************************************!*\
  !*** ./src/app/layout/hourly-billing/components/hourly-billing/hourly-billing.component.scss?ngResource ***!
  \**********************************************************************************************************/
/***/ ((module) => {

module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJob3VybHktYmlsbGluZy5jb21wb25lbnQuc2NzcyJ9 */";
...
//# sourceMappingURL=src_app_layout_hourly-billing_hourly-billing_module_ts.js.map